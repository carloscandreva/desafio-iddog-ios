...
class BeerListCollectionViewController: UICollectionViewController, Storyboarded {
    struct Constants {
...
extension BeerListCollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let cell = collectionView.cellForItem(at: indexPath) as? BeerCollectionViewCell {
            coordinator?.beerDetail(beerViewModel: cell.beerViewModel)
        }
    }
